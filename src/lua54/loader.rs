use super::common::{
	types::{AbsLine, Constant, Inst, Proto, LUA_DATA, LUA_INT, LUA_MAGIC, LUA_NUM},
	varint::load_unsigned,
};
use crate::common::{
	loader::{verify_size_of, Serde},
	types::{Instruction, Integer, Local, Number, Res, Upvalue, Value},
};
use nom::{
